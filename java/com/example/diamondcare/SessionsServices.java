...
import com.example.Glamsy.Adapter.MyTimeSlotAdapter;
import com.example.Glamsy.Adapter.ServicesAdapter;
import com.example.Glamsy.Model.ServicesData;
import com.example.Glamsy.Model.TimeSlotData;
...
public class SessionsServices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        servicesData.add(new ServicesData(getString(R.string.Glamsy),getString(R.string.GlamsyDescription),R.drawable.Glamsy, "40 €"));
        setOnClickListner();
