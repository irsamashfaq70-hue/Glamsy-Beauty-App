...
import com.example.Glamsy.Model.Appointment;
import com.example.Glamsy.Model.User;
import com.example.Glamsy.Utility.NetworkChangeListener;
import com.example.Glamsy.Utility.ReminderBroadcast;
...
public class Sessions_step3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userID = user.getUid();
        databaseReference = FirebaseDatabase.getInstance("https://Glamsy-care-22e78-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Users");
                        ...
                        databaseReference.child(userID).updateChildren(User).addOnCompleteListener(new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                ...
                                if (task.isSuccessful()){
                                    ...
                                    user = FirebaseAuth.getInstance().getCurrentUser();
                                    reference = FirebaseDatabase.getInstance("https://Glamsy-care-22e78-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Users");
                                    userID =  user.getUid();
...
//                                    alarmManager.set(AlarmManager.RTC_WAKEUP,timeAtButtonClick + tenSecondsInMillis,pendingIntent);
    ...
    public void createNotification(){
            CharSequence name = "Glamsy Care";
            String description = "Lembrete de marcação";
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
            NotificationChannel channel = new NotificationChannel("Glamsy Care", name, importance);
